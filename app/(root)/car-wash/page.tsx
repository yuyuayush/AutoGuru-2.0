        ...
        <div className="min-h-screen">
            ...
            <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto animate-in fade-in zoom-in duration-700">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            href="#packages"
                            className="px-8 py-4 bg-primary hover:bg-[#a88235] text-white rounded-full font-semibold transition-all transform hover:scale-105 shadow-lg"
                        >
                            View Packages
                        </Link>
                        <Link
            ...
            <section className="py-20 bg-[#111]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-black p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-white/10">
                            <div className="w-14 h-14 bg-blue-900/20 rounded-xl flex items-center justify-center mb-6 text-blue-400">
                                <Droplets className="w-7 h-7" />
                            </div>
                            <h3 className="text-xl font-bold text-white mb-3">Eco-Friendly Products</h3>
                        ...
                        <div className="bg-black p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-white/10">
                            <div className="w-14 h-14 bg-purple-900/20 rounded-xl flex items-center justify-center mb-6 text-purple-400">
                                <ShieldCheck className="w-7 h-7" />
                            </div>
                            <h3 className="text-xl font-bold text-white mb-3">Paint Protection</h3>
                            <p className="text-gray-400 leading-relaxed">
                                Our premium wax and ceramic coating options provide long-lasting protection against UV rays, rain, and road grime.
                            </p>
                        </div>
                        <div className="bg-black p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-white/10">
                            <div className="w-14 h-14 bg-green-900/20 rounded-xl flex items-center justify-center mb-6 text-green-400">
            ...
            <section id="packages" className="py-24 bg-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-white mb-4">Choose Your Wash Package</h2>
                        <p className="text-xl text-gray-400">Transparent pricing for every level of clean</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {/* Basic Package */}
                        <div className="relative p-8 bg-[#111] border border-white/10 rounded-3xl hover:border-blue-500/50 transition-colors group">
                            <h3 className="text-2xl font-bold text-white mb-2">Express Wash</h3>
                            ...
                            <button className="w-full py-3 px-6 rounded-xl border-2 border-white text-white font-semibold hover:bg-white hover:text-black transition-colors">
                                Book Now
                            </button>
                        </div>

                        {/* Premium Package */}
                        <div className="relative p-8 bg-[#1a1a1a] text-white rounded-3xl shadow-xl transform md:-translate-y-4 border border-blue-500/30">
                            ...
                            <p className="text-gray-300 mb-8 pb-8 border-b border-white/10">
                        ...
                        {/* Ultimate Package */}
                        <div className="relative p-8 bg-[#111] border border-white/10 rounded-3xl hover:border-blue-500/50 transition-colors group">
                            <h3 className="text-2xl font-bold text-white mb-2">Showroom Shine</h3>
                            <div className="flex items-baseline gap-1 mb-6">
            ...
            <section className="py-20 bg-[#111]">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="bg-blue-900/30 border border-blue-500/20 rounded-3xl p-12 relative overflow-hidden">
                        {/* Decorative circles */}
                        <div className="absolute top-0 left-0 w-64 h-64 bg-blue-500/10 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl" />
                        <div className="absolute bottom-0 right-0 w-64 h-64 bg-blue-400/10 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl" />
                        ...
                        <div className="relative z-10">
                            ...
                            <Link
                                href="/book-service"
                                className="inline-flex items-center justify-center px-8 py-4 bg-white text-blue-900 rounded-full font-bold hover:bg-gray-100 transition-colors shadow-lg"
                            >
                                Book Appointment
                            </Link>
                        </div>
