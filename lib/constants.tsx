...
export const TESTIMONIALS = [
  {
    ...
    role: "Porsche Owner",
    content:
      "AutoGuru provides exceptional service. They treat my car with the utmost care and professionalism. Highly recommended for luxury vehicles.",
    rating: 5,
  ...
  },
  {
    ...
    role: "BMW Enthusiast",
    content:
      "I've tried many mechanics, but AutoGuru stands out. Their attention to detail and transparent pricing is refreshing. A truly premium experience.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Audi Driver",
    content:
      "Fast, reliable, and friendly. The team at AutoGuru knows exactly what they are doing. My car runs smoother than ever.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Mercedes Owner",
    content:
      "The diagnostics were spot on. They fixed an issue two other shops couldn't figure out. I'm a customer for life now.",
    rating: 5,
    image: "/testimonial/avatar1.jpg",
  },
  {
    ...
    content:
      "Professionalism at its finest. The waiting area is clean, the staff is polite, and my car was ready exactly when promised.",
    rating: 5,
    image: "/testimonial/avatar2.jpg",
  },
  {
    ...
    role: "Lexus Owner",
    content:
      "Great value for the level of service provided. It feels like a dealership experience without the dealership price tag.",
    rating: 5,
    image: "/testimonial/avatar3.jpg",
  },
];
...
export const HERO_SLIDES = [
  {
    ...
    subtitle:
      "Experience the highest standard of automotive care with our certified experts.",
  ...
  },
  {
    ...
    highlight: "& REPAIR",
    subtitle:
      "State-of-the-art equipment to diagnose and fix issues with precision.",
  ...
  },
  {
    ...
    subtitle:
      "We use only authentic parts to ensure your vehicle's longevity and performance.",
    ctaText: "Contact Us",
    ctaLink: "/contact",
  },
];
...
export const CAR_REPAIR_SERVICES = [
  ...
  },
  {
    ...
    layout: "vertical",
    items: ["Car Battery Replacement", "Battery cable replacement"],
  },
  {
    category: "Body",
...
export const MECHANIC_FAQS = [
  {
    ...
    answer:
      "You can get your car serviced at any of our certified mechanics or workshops listed on AutoGuru. We have a wide network of trusted professionals across the country.",
  },
  {
    question: "Do I need to service my car before I sell it?",
    answer:
      "While not legally required, servicing your car before selling it can increase its value and appeal to potential buyers, showing that the vehicle has been well-maintained.",
  },
  {
    question: "Do I legally need to get my car serviced regularly?",
    answer:
      "There is no legal requirement to service your car, but regular servicing is crucial for safety, reliability, and maintaining your vehicle's warranty and resale value.",
  },
  {
    question: "Can I Buy Now, Pay Later my car service?",
    answer:
      "Yes! AutoGuru offers flexible payment options including Afterpay, Humm, and Zip, allowing you to service your car now and pay later.",
  },
  {
    question:
      "Will servicing my car with an independent mechanic void my warranty?",
    answer:
      "No. As long as the mechanic is qualified and uses parts that meet the manufacturer's specifications, your warranty will remain intact.",
  },
];
...
export const MOBILE_MECHANIC_FAQS = [
  {
    ...
    answer:
      "Mobile mechanics can perform a wide range of services including logbook servicing, brake repairs, battery replacements, diagnostics, and general repairs right at your location.",
  },
  {
    question: "Is it more expensive to use a mobile mechanic?",
    answer:
      "Not necessarily. Mobile mechanics often have lower overhead costs than traditional workshops, which can sometimes result in more competitive pricing.",
  },
  {
    question: "Do I need to provide tools or equipment?",
    answer:
      "No, our mobile mechanics come fully equipped with all the necessary tools and diagnostic equipment to complete the job.",
  },
  {
    question: "What if my car needs a major repair that can't be done on-site?",
    answer:
      "If a repair requires a workshop hoist or specialized equipment, the mobile mechanic will advise you on the best course of action and can often arrange for the vehicle to be taken to a workshop.",
  },
];
...
export const AIR_CONDITIONING_FAQS = [
  {
    ...
    answer:
      "It is recommended to service your car's air conditioning every 1-2 years to ensure it runs efficiently and to prevent gas leaks.",
  },
  {
    question: "Why is my car AC blowing warm air?",
    answer:
      "Common causes include low refrigerant gas, a blocked condenser, a faulty compressor, or electrical issues. A diagnostic check can identify the problem.",
  },
  {
    question: "What is an AC re-gas?",
    answer:
      "An AC re-gas involves removing the old refrigerant gas and replacing it with new gas to restore the cooling performance of your air conditioning system.",
  },
  {
    question: "Does AC service include checking for leaks?",
    answer:
      "Yes, a comprehensive AC service includes a pressure test and leak detection to ensure the system is sealed and operating correctly.",
  },
];
...
export const RECENT_REVIEWS = [
  {
    ...
    review:
      "They helped me out with a last minute rego inspection, even though they were clearly busy at the time. This showed great customer service and really impressed me.",
    image: "/hero/hero-car-1.avif",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    date: "19 November 2025",
    review:
      "I'm new to the area and found this shop through AutoGuru. I booked a basic service and RWC for my Camry, and the whole process was quick, smooth, and fairly priced.",
    image: "/hero/hero-car-3.avif",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    review:
      "Ultra Tune, Tuggeranong worked with me to resolve a complex mechanical issue with my 25 year old vehicle. Very happy.",
    image: "/hero/hero-car-3.avif",
  },
];
...
export const CAR_ADVICE_FAQS = [
  {
    ...
    answer:
      "Most manufacturers recommend servicing every 10,000-15,000 km or 6-12 months, whichever comes first. However, consult your owner's manual for specific recommendations for your vehicle model and driving conditions.",
  },
  {
    question: "When should I replace my brake pads?",
    answer:
      "Brake pads typically last 25,000-65,000 km, depending on driving habits and vehicle type. Replace them when they're down to 3mm thickness, or if you hear squeaking or grinding sounds.",
  },
  {
    question: "Why is my check engine light on?",
    answer:
      "The check engine light can indicate many things, from minor issues like a loose gas cap to more serious problems. Have it checked by a professional to prevent further damage and ensure optimal performance.",
  },
];
...
export const CAR_BATTERY_FAQS = [
  {
    ...
    answer:
      "On average, a car battery lasts between 3 to 5 years. However, this can vary depending on your driving habits, climate, and the type of vehicle you drive.",
  },
  {
    question: "How much does a car battery cost?",
    answer:
      "Car battery prices vary depending on the make and model of your vehicle. You can get a fixed-price quote instantly on AutoGuru.",
  },
  {
    question: "Does the battery warning light mean I need a new battery?",
    answer:
      "Not necessarily. It could indicate a problem with the alternator, a loose connection, or a dying battery. It's best to get it tested by a professional.",
  },
  {
    question: "Will driving my car recharge a flat battery?",
    answer:
      "Driving can recharge a battery if it was only slightly drained. However, if the battery is old or deeply discharged, driving might not be enough, and you may need a replacement.",
  },
  {
    question: "Will the battery go flat if I don't use my car?",
    answer:
      "Yes, batteries naturally lose charge over time, even when not in use. If you plan to leave your car parked for an extended period, consider using a trickle charger.",
  },
  {
    question:
      "Do I need a special battery for a vehicle fitted with a stop/start feature?",
    answer:
      "Yes, vehicles with stop/start technology require specialized batteries (like AGM or EFB) to handle the frequent starting cycles.",
  },
  {
    question: "Which car battery brand does AutoGuru recommend?",
    answer:
      "We recommend high-quality brands that offer reliable performance and good warranties. Our mechanics supply top-rated batteries suitable for your specific vehicle.",
  },
];
...
export const BATTERY_SERVICES_LINKS = [
  {
    ...
    href: "/car-repair-service/car-battery-replacement",
  },
  {
    label: "Battery cable replacement",
    href: "/car-battery/cable-replacement",
  },
...
export const WINDSCREEN_FAQS = [
  {
    ...
    answer:
      "If the chip is smaller than a $1 coin and not in the driver's direct line of sight, it can often be repaired. Otherwise, a replacement is necessary.",
  },
  {
    question: "How long does a windscreen replacement take?",
    answer:
      "A replacement usually takes about 60-90 minutes, but you'll need to wait another hour for the adhesive to cure before driving.",
  },
  {
    question: "Do you offer mobile windscreen service?",
    answer:
      "Yes! Our mobile technicians can come to your home or workplace to repair or replace your windscreen.",
  },
  {
    question: "Will my insurance cover it?",
    answer:
      "Many comprehensive insurance policies cover windscreen damage. We can often bill your insurer directly.",
  },
];
...
export const WINDSCREEN_SERVICES_LINKS = [
  {
    ...
    href: "/car-repair-service/windscreen-replacement",
  },
...
export const AIR_CONDITIONING_SERVICES_LINKS = [
  ...
  {
    label: "AC Service",
    href: "/car-repair-service/car-air-conditioning/service",
  },
  {
    label: "Compressor Replacement",
    href: "/car-repair-service/car-air-conditioning/compressor",
  },
  {
    label: "Leak Detection",
    href: "/car-repair-service/car-air-conditioning/leak-detection",
  },
];

export const expertServices = [
  "Brake Inspection & Repair",
  "Car Battery Check & Replacement",
...
export const features = [
  {
    ...
    subIcon: (
      <ArrowDown className="w-4 h-4 text-red-500 absolute -bottom-1 -right-1 stroke-[3px]" />
    ),
    title: "Fewer Calls",
  ...
  },
  {
    ...
    glowColor: "group-hover:shadow-[0_0_30px_rgba(234,179,8,0.2)]",
  ...
  },
  {
    ...
    glowColor: "group-hover:shadow-[0_0_30px_rgba(191,149,63,0.2)]",
...
export const testimonials = [
  {
    ...
    image: "/hero/hero-car-1.avif",
    content:
      "The level of transparency and efficiency AutoGuru provides is unmatched. It has completely transformed how we manage our fleet's downtime.",
    rating: 5,
  },
  {
    id: 2,
    ...
    image: "/hero/hero-car-2.avif",
    content:
      "Finally, a portal that simplifies the approval process. We've cut our administrative time in half since switching to this platform.",
    rating: 5,
  },
  {
    id: 3,
    ...
    image: "/hero/hero-car-3.avif",
    content:
      "Seamless integration and instant payments. Our mechanics are happier, and our cars are back on the road faster than ever.",
    rating: 5,
  },
  {
    id: 4,
    ...
    image: "/hero/hero-car-1.avif",
    content:
      "Premium service for a premium fleet. The dashboard insights alone are worth the investment. Highly recommended.",
    rating: 5,
  },
];
...
export const footerLinks = [
  {
    ...
    title: "Mechanics",
    links: [
      { label: "All Mechanics", href: "/mechanics" },
      { label: "Sydney Mechanics", href: "/mechanics/sydney" },
      { label: "Melbourne Mechanics", href: "/mechanics/melbourne" },
      { label: "Brisbane Mechanics", href: "/mechanics/brisbane" },
    ],
  },
  {
    id: "repairs",
    ...
    links: [
      ...
      { label: "Brake Repairs", href: "/brakes" },
      { label: "Suspension", href: "/suspension" },
      { label: "Clutch Replacement", href: "/clutch" },
    ],
  },
  {
    id: "makes",
    title: "Popular Makes",
    links: [
      { label: "Toyota Service", href: "/toyota" },
      { label: "Mazda Service", href: "/mazda" },
      { label: "Hyundai Service", href: "/hyundai" },
      { label: "Ford Service", href: "/ford" },
    ],
  },
];
